...
const ModelViewer = () => {
  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '100%' }}>
      ...
      <header style={{ position: 'absolute', top: 0, left: 0, width: '100%', color: 'white', zIndex: 1 }}>
        <nav>
          <ul>
      ...
      <h1 style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', color: 'white', zIndex: 1 }}>
        MELTOMIR
      </h1>
    </div>
  );
